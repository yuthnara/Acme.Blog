<?php
namespace Acme\Blog\ViewHelpers;
 ...
 * ::
 *
 *   <f:if condition="{rank} > 100" or="{rank} < 0">
 *     Will be shown if rank is > 100 or < 0
 *   </f:if>
 ...
 * <f:if condition="somecondition" or="somecondition">
 ...
 * {f:if(condition: someVariable, or: someVariable, then: 'condition is met', else: 'condition is not met')}
 * </code>
 * <output>
...
class IfViewHelper extends AbstractConditionViewHelper {
     ...
     * @param boolean $or View helper or condition
     *
